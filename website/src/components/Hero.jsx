  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6">
      <div className="lg:col-span-8">
        ...
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tighter text-on-surface leading-tight">
          Airport Pavement Structural<br className="hidden sm:inline" /> Evaluation using FAARFIELD
        </h2>
      ...
      <div className="lg:col-span-4 grid grid-cols-2 gap-3 lg:gap-4">
        <div className="bg-failing-bg rounded-xl p-4 lg:p-6 flex flex-col items-center justify-center">
          <span className="text-4xl lg:text-5xl font-extrabold text-failing">{underCount}</span>
        ...
        <div className="bg-adequate-bg rounded-xl p-4 lg:p-6 flex flex-col items-center justify-center">
          <span className="text-4xl lg:text-5xl font-extrabold text-adequate">{overCount}</span>
